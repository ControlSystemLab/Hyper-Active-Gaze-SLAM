...
def generate_launch_description(): 
    ...
    x_spawn_arg = DeclareLaunchArgument('x_spawn', default_value='14.3')
    y_spawn_arg = DeclareLaunchArgument('y_spawn', default_value='13.35')
    z_spawn_arg = DeclareLaunchArgument('z_spawn', default_value='11.16')
